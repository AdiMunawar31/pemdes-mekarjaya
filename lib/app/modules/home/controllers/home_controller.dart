...
class HomeController extends GetxController {
  ...
  Future<String> getDistanceToOffice() async {
    ...
    if (!determinePosition["error"]) {
      ...
      Get.snackbar("GPS belum aktif", determinePosition["message"]);
      return "-";
    }
  }
  ...
  Future<Map<String, dynamic>> _determinePosition() async {
    ...
    if (!serviceEnabled) {
      ...
      Get.rawSnackbar(
        ...
        message: 'Anda perlu mengaktifkan GPS',
  ...
  Stream<DocumentSnapshot<Map<String, dynamic>>> streamTodayPresence() async* {
    ...
    yield* firestore.collection("pegawai").doc(uid).collection("presensi").doc(todayDocId).snapshots();
  }
}
